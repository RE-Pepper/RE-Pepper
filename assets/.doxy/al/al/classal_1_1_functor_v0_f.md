...
[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**FunctorV0F**](classal_1_1_functor_v0_f.md)





* `#include <alFunctorV0F.h>`
...
| Type | Name |
| ---: | :--- |
|   | [**FunctorV0F**](#function-functorv0f) ([**FuncType**](classal_1_1_functor_v0_f.md#typedef-functype) func) <br> |
| virtual [**FunctorBase**](classal_1_1_functor_base.md) \* | [**clone**](#function-clone) () const<br> |
...
```C++
inline al::FunctorV0F::FunctorV0F (
    FuncType func
) 
```
...
```C++
inline virtual FunctorBase * al::FunctorV0F::clone () const
```
...
```C++
inline virtual void al::FunctorV0F::operator() () const
```
...
------------------------------
The documentation for this class was generated from the following file `/home/runner/work/RE-Pepper/RE-Pepper/lib/al/backup/include/Functor/alFunctorV0F.h`
