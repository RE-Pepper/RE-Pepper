...
### typedef CreateActorFuncPtr 

```C++
typedef CreateFuncPtr<LiveActor>::Type al::CreateActorFuncPtr;
```
...
### typedef CreateAreaObjFuncPtr 

```C++
typedef CreateFuncPtr<AreaObj>::Type al::CreateAreaObjFuncPtr;
```
...
### typedef CreateCameraFuncPtr 

```C++
typedef CreateFuncPtr<Camera>::Type al::CreateCameraFuncPtr;
```
...
### typedef NameToActorCreator 

```C++
typedef NameToCreator<CreateActorFuncPtr> al::NameToActorCreator;
```
...
### typedef NameToAreaObjCreator 

```C++
typedef NameToCreator<CreateAreaObjFuncPtr> al::NameToAreaObjCreator;
```
...
### typedef NameToCameraCreator 

```C++
typedef NameToCreator<CreateCameraFuncPtr> al::NameToCameraCreator;
```
...
```C++
typedef ByamlIter al::PlacementInfo;
```
...
### function addVelocityToGravity 

```C++
void al::addVelocityToGravity (
    LiveActor * actor,
    float amount
) 
```
...
### function calcFrontDir 

```C++
void al::calcFrontDir (
    sead::Vector3f * out,
...
### function calcJointPos 

```C++
void al::calcJointPos (
    sead::Vector3f * out,
    const  LiveActor * actor,
...
### function calcLinkChildNum 

```C++
int al::calcLinkChildNum (
...
### function calcMtxLocalTrans 

```C++
void al::calcMtxLocalTrans (
    sead::Vector3f * out,
...
### function calcQuatSide 

```C++
void al::calcQuatSide (
    sead::Vector3f * out,
    const  LiveActor * from
) 
```
...
### function createActorFunction 

```C++
template<typename T>
LiveActor * al::createActorFunction (
    const  char * name
) 
```
...
### function createAndStartInitializeThread 

```C++
void al::createAndStartInitializeThread (
    sead::Heap * heap,
    int stackSize,
    const  FunctorBase & func
) 
```
...
### function createAreaObjFunction 

```C++
template<typename T>
AreaObj * al::createAreaObjFunction (
    const  char * name
) 
```
...
### function createCourseSelectHeap 
...
```C++
void al::createSceneResourceHeap (
    const  char * stageName
) 
```
...
### function createStringIfInStack 

```C++
const  char * al::createStringIfInStack (
    const  char * str
) 
```
...
void al::emitEffect (
    IUseEffectKeeper * p,
    const  char * name,
    const sead::Vector3f * at=nullptr
) 
```
...
### function getActionFrameMax 

```C++
float al::getActionFrameMax (
    const  LayoutActor * actor
) 
```
...
```C++
const sead::Vector3f * al::getCameraPos () 
```
...
```C++
sead::FrameHeap * al::getCourseSelectHeap () 
```
...
### function getCourseSelectResourceHeap 

```C++
sead::FrameHeap * al::getCourseSelectResourceHeap () 
```
...
### function getCurrentKeyTrans 

```C++
const sead::Vector3f & al::getCurrentKeyTrans (
    const  KeyPoseKeeper * p
) 
```
...
```C++
const sead::Vector3f & al::getFront (
    const  LiveActor * actor
) 
```
...
```C++
const sead::Vector3f & al::getGravity (
    const  LiveActor * actor
) 
```
...
```C++
sead::Vector3f * al::getGravityPtr (
    LiveActor * actor
) 
```
...
### function getHitSensor 

```C++
HitSensor * al::getHitSensor (
    const  LiveActor * actor,
    const  char * name
) 
```
...
### function getJointMtxPtr 

```C++
const sead::Matrix34f * al::getJointMtxPtr (
    const  LiveActor * actor,
    const  char * jointName
) 
```
...
```C++
const sead::Vector2f & al::getLeftStick (
    int port=0
) 
```
...
### function getLinksActorObjectName 

```C++
const  char * al::getLinksActorObjectName (
    const  ActorInitInfo & info,
    int index
) 
```
...
### function getLinksInfoByIndex 

```C++
bool al::getLinksInfoByIndex (
    PlacementInfo * out,
    const  ActorInitInfo & info,
    int index
) 
...
### function getLiveActorKit 

```C++
LiveActorKit * al::getLiveActorKit () 
```
...
### function getNextKeyPlacementInfo 

```C++
const  PlacementInfo * al::getNextKeyPlacementInfo (
    const  KeyPoseKeeper * p
) 
```
...
### function getNextKeyTrans 

```C++
const sead::Vector3f & al::getNextKeyTrans (
    const  KeyPoseKeeper * p
) 
```
...
```C++
inline const  PlacementInfo & al::getPlacementInfo (
    const  ActorInitInfo & info
) 
```
...
```C++
const sead::Vector3f & al::getRailDir (
    const  LiveActor * actor
) 
```
...
```C++
const sead::Vector3f & al::getRotate (
    const  LiveActor * actor
) 
```
...
```C++
const sead::Vector3f & al::getScale (
    const  LiveActor * actor
) 
```
...
```C++
sead::FrameHeap * al::getSceneHeap () 
```
...
### function getSceneObjHolder 

```C++
SceneObjHolder * al::getSceneObjHolder () 
```
...
```C++
sead::FrameHeap * al::getSceneResourceHeap () 
```
...
```C++
sead::ExpHeap * al::getSequenceHeap () 
```
...
### function getStageSwitchName 

```C++
const  char * al::getStageSwitchName (
    StageSwitchType type
) 
```
...
```C++
sead::ExpHeap * al::getStationedHeap () 
```
...
```C++
const sead::Vector3f & al::getTrans (
    const  LiveActor * actor
) 
```
...
```C++
const sead::Vector3f & al::getVelocity (
    const  LiveActor * actor
) 
```
...
```C++
sead::Vector3f * al::getVelocityPtr (
    LiveActor * actor
) 
```
...
### function initActorEffectKeeper 

```C++
void al::initActorEffectKeeper (
    LiveActor * actor,
    const  ActorInitInfo & info,
    const  char *
) 
...
### function initActorPoseTFGSV 

```C++
void al::initActorPoseTFGSV (
    LiveActor * actor
) 
```
...
### function initActorPoseTFSV 

```C++
void al::initActorPoseTFSV (
    LiveActor * actor
) 
```
...
### function initActorPoseTQSV 

```C++
void al::initActorPoseTQSV (
    LiveActor * actor
) 
```
...
### function initActorPoseTRSV 

```C++
void al::initActorPoseTRSV (
    LiveActor * actor
) 
```
...
### function initActorSRTAndPoseTRSV 

```C++
void al::initActorSRTAndPoseTRSV (
    LiveActor * actor,
    const  ActorInitInfo & info
) 
```
...
### function initActorWithArchiveName 

```C++
void al::initActorWithArchiveName (
    LiveActor * actor,
    const  ActorInitInfo & info,
...
### function initActorWithArchiveNameNoPlacementInfo 

```C++
void al::initActorWithArchiveNameNoPlacementInfo (
    LiveActor * actor,
    const  ActorInitInfo & info,
    const sead::SafeString & archiveName,
    const  char * suffix=nullptr
...
### function initCreateActorNoPlacementInfo 

```C++
void al::initCreateActorNoPlacementInfo (
    LiveActor * actor,
...
### function initCreateActorWithPlacementInfo 

```C++
void al::initCreateActorWithPlacementInfo (
    LiveActor * actor,
    const  ActorInitInfo & hostInfo
) 
```
...
### function initLayoutActor 

```C++
void al::initLayoutActor (
...
### function initLayoutInitInfo 

```C++
void al::initLayoutInitInfo (
    LayoutInitInfo * info,
    LiveActorKit *
) 
```
...
### function initMapPartsActor 

```C++
void al::initMapPartsActor (
    LiveActor * actor,
    const  ActorInitInfo & info
) 
```
...
### function initNerveState 

```C++
void al::initNerveState (
    IUseNerve * p,
    NerveStateBase * state,
    const  Nerve * stateNrv,
    const  char * name
) 
```
...
```C++
void al::initPlacementMap (
    Scene * scene,
    const  Resource * stageArchive,
...
### function initStageSwitchA 

```C++
void al::initStageSwitchA (
    IUseStageSwitch * p,
    const  ActorInitInfo & info
) 
```
...
### function initStageSwitchAppear 

```C++
void al::initStageSwitchAppear (
    IUseStageSwitch * p,
    const  ActorInitInfo & info
) 
```
...
### function initStageSwitchB 

```C++
void al::initStageSwitchB (
    IUseStageSwitch * p,
    const  ActorInitInfo & info
) 
```
...
### function initStageSwitchKill 

```C++
void al::initStageSwitchKill (
    IUseStageSwitch * p,
    const  ActorInitInfo & info
) 
```
...
### function invalidateCollisionPartsBySystem 

```C++
void al::invalidateCollisionPartsBySystem (
    LiveActor * actor
) 
```
...
### function isCollidedGround 

```C++
bool al::isCollidedGround (
    const  LiveActor * actor
) 
```
...
### function isCollidedWall 

```C++
bool al::isCollidedWall (
    const  LiveActor * actor
) 
```
...
### function isCreatedSceneResourceHeap 
...
### function isExistArchive 

```C++
bool al::isExistArchive (
    const sead::SafeString & archive
) 
```
...
### function isExistSceneObj 

```C++
bool al::isExistSceneObj (
    int id
) 
```
...
### function isGreaterEqualStep 

```C++
bool al::isGreaterEqualStep (
    const  IUseNerve * p,
    int step
) 
```
...
### function isGreaterStep 

```C++
bool al::isGreaterStep (
    const  IUseNerve * p,
    int step
) 
```
...
### function isHitCylinderSensor 

```C++
bool al::isHitCylinderSensor (
    HitSensor *,
    HitSensor *,
    const sead::Vector3f &,
    float
...
### function isInvalidClipping 

```C++
bool al::isInvalidClipping (
    const  LiveActor * actor
) 
```
...
### function isObjectName 

```C++
bool al::isObjectName (
    const  ActorInitInfo & info,
...
### function isPadRelease 

```C++
bool al::isPadRelease (
    int port,
    int mask
) 
```
...
### function isPadTrigger 

```C++
bool al::isPadTrigger (
    int port,
    int mask
) 
```
...
### function isRailReachedGoal 

```C++
bool al::isRailReachedGoal (
    const  LiveActor * actor
) 
```
...
### function isSensorEnemy 

```C++
bool al::isSensorEnemy (
...
### function isSensorEnemyAttack 

```C++
bool al::isSensorEnemyAttack (
    const  HitSensor * sensor
) 
```
...
### function isSensorEnemyBody 

```C++
bool al::isSensorEnemyBody (
    const  HitSensor * sensor
) 
```
...
### function isSensorMapObj 

```C++
bool al::isSensorMapObj (
    const  HitSensor * sensor
) 
```
...
### function isSensorName 

```C++
bool al::isSensorName (
    HitSensor * sensor,
    const  char * name
) 
```
...
### function isSensorPlayer 

```C++
bool al::isSensorPlayer (
    const  HitSensor * sensor
) 
```
...
### function isSensorRide 

```C++
bool al::isSensorRide (
    const  HitSensor * sensor
) 
```
...
### function isSensorSimple 

```C++
bool al::isSensorSimple (
    const  HitSensor * sensor
) 
```
...
### function listenStageSwitchOnAppear 

```C++
bool al::listenStageSwitchOnAppear (
    IUseStageSwitch * p,
    const  FunctorBase & onFunctor,
...
### function makeLocalizedArchivePath 

```C++
void al::makeLocalizedArchivePath (
    sead::BufferedSafeString * out,
    const sead::SafeString & archive
) 
```
...
### function makeStageDataArchivePath 

```C++
void al::makeStageDataArchivePath (
    sead::BufferedSafeString * out,
    const  char * stageName,
    int scenario,
    const  char * type
...
### function moveSyncRail 

```C++
void al::moveSyncRail (
    LiveActor * actor,
    float speed
) 
```
...
### function moveSyncRailLoop 

```C++
void al::moveSyncRailLoop (
    LiveActor * actor,
    float speed
) 
```
...
### function moveSyncRailTurn 

```C++
void al::moveSyncRailTurn (
    LiveActor * actor,
    float speed
) 
```
...
### function onDrawClipping 

```C++
void al::onDrawClipping (
    LiveActor * actor
) 
```
...
### function registerExecutorFunctor 

```C++
void al::registerExecutorFunctor (
    const  FunctorBase & base,
    const  char * name
) 
```
...
### function registerExecutorFunctorDraw 

```C++
void al::registerExecutorFunctorDraw (
    const  FunctorBase & base,
    const  char * name
) 
```
...
### function registerExecutorUser 

```C++
void al::registerExecutorUser (
    IUseExecutor * p,
    const  char * name
) 
```
...
### function removeExtensionString 

```C++
char * al::removeExtensionString (
    char * res,
    size_t size,
    const  char * str
) 
...
### function rotateQuatXDirDegree 

```C++
void al::rotateQuatXDirDegree (
    LiveActor * actor,
    const sead::Quatf & from,
    float degrees
) 
...
### function rotateQuatYDirDegree 

```C++
void al::rotateQuatYDirDegree (
    LiveActor * actor,
    const sead::Quatf & from,
    float degrees
) 
...
### function rotateQuatZDirDegree 

```C++
void al::rotateQuatZDirDegree (
    LiveActor * actor,
    const sead::Quatf & from,
    float degrees
) 
...
### function setActionFrameRate 

```C++
void al::setActionFrameRate (
    LayoutActor * actor,
    float rate
) 
```
...
### function setBaseMtxAndCalcAnim 

```C++
void al::setBaseMtxAndCalcAnim (
    LiveActor * actor,
...
### function setPaneString 

```C++
void al::setPaneString (
    LayoutActor * actor,
    const  char * paneName,
    const  wchar_t * text
) 
...
### function setSyncRailToStart 

```C++
void al::setSyncRailToStart (
    LiveActor * actor
) 
```
...
void al::startAction (
    LayoutActor * actor,
    const sead::SafeString & actionName
) 
```
...
### function startHitReaction 

```C++
void al::startHitReaction (
    const  LiveActor * actor,
    const  char * name
) 
```
...
### function startNerveAction 

```C++
void al::startNerveAction (
    LiveActor * actor,
    const  char * actionName
) 
```
...
### function syncCollisionMtx 

```C++
void al::syncCollisionMtx (
    LiveActor * actor,
    const sead::Matrix34f *
) 
```
...
### function tryCreateRailKeeper 

```C++
RailKeeper * al::tryCreateRailKeeper (
    const  PlacementInfo & info
) 
```
...
### function tryEmitEffect 

```C++
bool al::tryEmitEffect (
    IUseEffectKeeper * p,
    const  char * name
) 
```
...
### function tryGetObjectName 

```C++
bool al::tryGetObjectName (
    const  char ** out,
    const  ActorInitInfo & info
) 
```
...
### function tryGetPlacementInfo 

```C++
bool al::tryGetPlacementInfo (
    PlacementInfo * out,
    const  Resource * stageArchive,
    const  char * infoIterName
) 
...
### function tryGetRailIter 

```C++
bool al::tryGetRailIter (
    PlacementInfo * out,
    const  PlacementInfo & info
) 
```
...
### function tryGetStringArg 

```C++
bool al::tryGetStringArg (
    const  char ** out,
    const  ActorInitInfo & info,
    const  char * argName
) 
...
### function tryStartMclAnimIfExist 

```C++
bool al::tryStartMclAnimIfExist (
    LiveActor * actor,
    const  char * animName
) 
```
...
### function tryStartMtpAnimIfExist 

```C++
bool al::tryStartMtpAnimIfExist (
    LiveActor * actor,
    const  char * animName
) 
```
...
### function tryStartMtsAnimIfExist 

```C++
bool al::tryStartMtsAnimIfExist (
    LiveActor * actor,
    const  char * animName
) 
```
...
### function tryStartSklAnimIfExist 

```C++
bool al::tryStartSklAnimIfExist (
    LiveActor * actor,
    const  char * animName
) 
```
...
### function tryStartVisAnimIfExist 

```C++
bool al::tryStartVisAnimIfExist (
    LiveActor * actor,
    const  char * animName
) 
```
...
### function trySyncStageSwitchAppear 

```C++
void al::trySyncStageSwitchAppear (
    LiveActor * actor
) 
```
...
### function trySyncStageSwitchKill 

```C++
void al::trySyncStageSwitchKill (
    LiveActor * actor
) 
```
...
### function updateNerveState 

```C++
bool al::updateNerveState (
    IUseNerve * p
) 
```
...
### function updateNerveStateAndNextNerve 

```C++
bool al::updateNerveStateAndNextNerve (
    IUseNerve * p,
    const  Nerve * nerve
) 
```
...
### function validateCollisionPartsBySystem 

```C++
void al::validateCollisionPartsBySystem (
    LiveActor * actor
) 
```
